...
function background() {
    switch (currentBackground) {
        ...
        case 2:
            ...
            break;
        case 3:
            mountain.style["boxShadow"] = forestMontain;
...
function speed() {
    ...
    switch (currentSpeed) {
        case 1:
            ...
            trees[0].style["animation"] = 'move 4s linear 3s infinite';
            trees[1].style["animation"] = 'move 4s linear 9s infinite';
            trees[2].style["animation"] = 'move 4s linear 6s infinite';
            trees[3].style["animation"] = 'move 4s linear 12s infinite';
        ...
        case 2:
            ...
            trees[0].style["animation"] = 'move 2s linear 2.5s infinite';
            trees[1].style["animation"] = 'move 2s linear 3.5s infinite';
            trees[2].style["animation"] = 'move 2s linear 3s infinite';
            trees[3].style["animation"] = 'move 2s linear 4s infinite';
        ...
        case 3:
            ...
            trees[0].style["animation"] = 'move 1s linear 2.5s infinite';
            trees[1].style["animation"] = 'move 1s linear 3.5s infinite';
            trees[2].style["animation"] = 'move 1s linear 3s infinite';
            trees[3].style["animation"] = 'move 1s linear 4s infinite';
...
function forest() {
    ...
    for (let element of trees) element.style["boxShadow"] = forestTree;
...
function snow() {
    ...
    for (let element of trees) element.style["boxShadow"] = snowTree;
...
function desert() {
    ...
    for (let element of trees) element.style["boxShadow"] = desertTree;
